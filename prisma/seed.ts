...
async function main() {
  ...
  const rolePermissionMap: Record<string, string[]> = {
    system_admin: [
      ...
      PERMISSIONS.INVENTORY_ADJUSTMENT_REQUESTS_CREATE,
      PERMISSIONS.INVENTORY_ADJUSTMENT_REQUESTS_READ_OWN,
      PERMISSIONS.INVENTORY_ADJUSTMENT_REQUESTS_READ,
      PERMISSIONS.INVENTORY_ADJUSTMENT_REQUESTS_REVIEW,
    ],
    worker: [
      PERMISSIONS.CAMPS_READ,
      PERMISSIONS.RESOURCES_READ,
