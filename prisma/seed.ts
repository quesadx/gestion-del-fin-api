...
async function main() {
  ...
  const tableNames = [
    "user_achievements", "achievements", "admission_requests", 
    "camp_transfer_item", "camp_transfers", "expedition_allocated_resources",
    "expedition_found_resources", "expedition_members", "expeditions",
    "inventory_log", "inventory", "contribution_overrides",
    "profession_reassignment_log", "person_status_log", "persons",
    "professions_resources_amounts", "professions", "resource_type",
    "users", "roles", "camps", "system_config", "Post", "User"
  ];
