...
-- DropForeignKey
ALTER TABLE "admission_requests" DROP CONSTRAINT "admission_requests_camp_id_fkey";
ALTER TABLE "admission_requests" DROP CONSTRAINT "admission_requests_reviewed_by_fkey";
ALTER TABLE "audit_log" DROP CONSTRAINT "audit_log_camp_id_fkey";
ALTER TABLE "audit_log" DROP CONSTRAINT "audit_log_user_id_fkey";
ALTER TABLE "camp_transfer_item" DROP CONSTRAINT "camp_transfer_item_camp_transfer_id_fkey";
ALTER TABLE "camp_transfer_item" DROP CONSTRAINT "camp_transfer_item_person_id_fkey";
ALTER TABLE "camp_transfer_item" DROP CONSTRAINT "camp_transfer_item_resource_type_id_fkey";
ALTER TABLE "camp_transfers" DROP CONSTRAINT "camp_transfers_approved_by_source_fkey";
ALTER TABLE "camp_transfers" DROP CONSTRAINT "camp_transfers_approved_by_target_fkey";
ALTER TABLE "camp_transfers" DROP CONSTRAINT "camp_transfers_leader_person_id_fkey";
ALTER TABLE "camp_transfers" DROP CONSTRAINT "camp_transfers_requested_by_fkey";
ALTER TABLE "camp_transfers" DROP CONSTRAINT "camp_transfers_requesting_camp_fkey";
ALTER TABLE "camp_transfers" DROP CONSTRAINT "camp_transfers_target_camp_fkey";
ALTER TABLE "contribution_overrides" DROP CONSTRAINT "contribution_overrides_created_by_fkey";
ALTER TABLE "contribution_overrides" DROP CONSTRAINT "contribution_overrides_person_id_fkey";
ALTER TABLE "contribution_overrides" DROP CONSTRAINT "contribution_overrides_resource_type_id_fkey";
ALTER TABLE "expedition_allocated_resources" DROP CONSTRAINT "expedition_allocated_resources_expedition_id_fkey";
ALTER TABLE "expedition_allocated_resources" DROP CONSTRAINT "expedition_allocated_resources_resource_type_id_fkey";
ALTER TABLE "expedition_found_resources" DROP CONSTRAINT "expedition_found_resources_expedition_id_fkey";
ALTER TABLE "expedition_found_resources" DROP CONSTRAINT "expedition_found_resources_resource_type_id_fkey";
ALTER TABLE "expedition_members" DROP CONSTRAINT "expedition_members_expedition_id_fkey";
ALTER TABLE "expedition_members" DROP CONSTRAINT "expedition_members_person_id_fkey";
ALTER TABLE "expeditions" DROP CONSTRAINT "expeditions_camp_id_fkey";
ALTER TABLE "expeditions" DROP CONSTRAINT "expeditions_created_by_fkey";
ALTER TABLE "inventory" DROP CONSTRAINT "inventory_camp_id_fkey";
ALTER TABLE "inventory" DROP CONSTRAINT "inventory_resource_type_id_fkey";
ALTER TABLE "inventory_log" DROP CONSTRAINT "inventory_log_camp_id_fkey";
ALTER TABLE "inventory_log" DROP CONSTRAINT "inventory_log_logged_by_fkey";
ALTER TABLE "inventory_log" DROP CONSTRAINT "inventory_log_resource_type_id_fkey";
ALTER TABLE "person_status_log" DROP CONSTRAINT "person_status_log_changed_by_fkey";
ALTER TABLE "person_status_log" DROP CONSTRAINT "person_status_log_person_id_fkey";
ALTER TABLE "persons" DROP CONSTRAINT "persons_camp_id_fkey";
ALTER TABLE "persons" DROP CONSTRAINT "persons_profession_id_fkey";
ALTER TABLE "profession_reassignment_log" DROP CONSTRAINT "profession_reassignment_log_from_profession_id_fkey";
ALTER TABLE "profession_reassignment_log" DROP CONSTRAINT "profession_reassignment_log_person_id_fkey";
ALTER TABLE "profession_reassignment_log" DROP CONSTRAINT "profession_reassignment_log_to_profession_id_fkey";
ALTER TABLE "professions_resources_amounts" DROP CONSTRAINT "professions_resources_amounts_professions_id_fkey";
ALTER TABLE "professions_resources_amounts" DROP CONSTRAINT "professions_resources_amounts_resource_type_id_fkey";
...
ALTER TABLE "users" DROP CONSTRAINT "users_camp_id_fkey";
...
ALTER TABLE "professions_resources_amounts" ADD CONSTRAINT "professions_resources_amounts_professions_id_fkey" FOREIGN KEY ("professions_id") REFERENCES "professions"("id") ON DELETE CASCADE ON UPDATE CASCADE;
